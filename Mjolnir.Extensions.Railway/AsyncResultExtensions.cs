...
/// <summary>
///     Provides Asynchronously extension methods for railway-oriented programming Result handling.
/// </summary>
public static class AsyncResultExtensions
{
    /// <summary>
    ///     Asynchronously retrieves the success value of the encapsulated result, or throws the failure exception if the
    ///     result is a failure.
    /// </summary>
    ...
    {
        /// <summary>
        ///     Asynchronously applies a given transformation function to the result of a task upon its completion.
        /// </summary>
        /// <typeparam name="TStart">The type of the initial result value that is yielded by the task.</typeparam>
        /// <typeparam name="TResult">The type of the result to be returned after applying the transformation function.</typeparam>
        /// <param name="next">A function that takes the initial result value and returns a new task with the transformed result.</param>
        /// <returns>A task that represents the asynchronous operation. The task result contains the transformed result value.</returns>
        ...
        /// <summary>
        ///     Asynchronously applies a transformation function to the result of a task upon its completion, and returns the
        ///     transformed result.
        /// </summary>
        /// <typeparam name="TStart">The type of the initial result value provided by the task.</typeparam>
        /// <typeparam name="TResult">The type of the result after applying the transformation function.</typeparam>
        /// <param name="next">A function that transforms the initial result value into a new result.</param>
